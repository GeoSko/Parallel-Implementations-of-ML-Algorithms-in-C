...
void printPherormones();                            //Prints the pherormone values
...
void allAntsTour(int iteration){
    ...
    memset(cityTaken, 0, sizeof(cityTaken)); //Reset the masks to zero
    // memset(Route, 0, sizeof(Route)); //Reset the masks to zero
